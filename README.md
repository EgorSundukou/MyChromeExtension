...
### 1. Запуск
При нажатии кнопки **«Запустить скрипт»** в попапе, расширение сохраняет флаг автозапуска в памяти браузера (`localStorage`) и начинает основной цикл поиска кнопок. Если страница перезагрузится, скрипт увидит этот флаг и автоматически продолжит работу.
